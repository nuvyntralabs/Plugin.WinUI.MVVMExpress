...
- Host / Navigation / Dialogs pack on Windows (`net10.0-windows10.0.19041.0`). Host tests are class libraries (`UseWinUI=false`) so testhost can load; they do not host a real `Frame`.
